    ...
    results: [
      {
        ...
        overview: '2023년 8월 31일부터 맥스에서 방영한 핀과 제이크의 어드벤처 타임의 스핀오프 애니메이션. 2018년에 방영된 핀과 제이크의 어드벤처 타임의 피날레 에피소드 Come Along With Me에서 바로 연결되는 시나리오로 5년만에 돌아와 기존 팬들에게 상당한 향수감과 훌륭한 팬 서비스를 제공해주었다. 뿐만 아니라 이제는 어른이 된 팬들을 위해 어드벤처 타임 특유의 기질은 남겨놓되 좀 더 진지하고 성인향 위주의 연출을 가미한 것도 호평할 만한 요소다.',
        popularity: 244.518,
      ...
      },
      {
        ...
        original_name: 'ワンピース',
        overview:
          '해적왕을 꿈꾸는 소년 루피와 동료들의 유쾌한 모험담을 그린 작품! 힘있는 연출과 개성있는 그림체 및 캐릭터들의 활기찬 묘사로 인기를 모았으며, 1억 만부 이상 판매된 원작만화의 인기를 바탕으로 다양한 버전으로 제작된 초히트작 애니메이션이다.\n\n˝최고의 해적왕˝을 꿈꾸는 루피와 동료들의 파란만장한 모험담 !\n\n떄는 해적들이 난무하는 ‘춘추전국시대’. 곳곳에서는 전설적인 해적왕 골드로저가 남긴 보물 ‘원피스’를 놓고 수많은 해적들이 서로 싸우고 있었다. 어릴 때부터 골드로저를 너무도 동경한 나머지 자신도 전설의 해적왕이 되는 것이 꿈인 주인공 루피. 해적왕을 꿈꾸는 루피는 수영을 할 수 없음에도 불구하고 물에 빠지지 않으면 된다면서 자신의 꿈을 향해 모험을 떠난다.',
        popularity: 250.463,
